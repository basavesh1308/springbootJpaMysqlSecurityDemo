...
public class MyUserDetails implements UserDetails {
    ...
    public MyUserDetails(UserCred userCred) {
        this.username = userCred.getUsername();
        this.password = userCred.getPassword();
        this.authorities = Arrays.stream(userCred.getRoles().split(",")).map(SimpleGrantedAuthority::new).collect(Collectors.toList());
        this.active = userCred.isActive();
    }
